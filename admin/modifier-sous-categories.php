...
if (isset($_POST['submit'])) {
   ...
   $_SESSION['message-success'] = CATEGORIES_MODIFY_SUCCESS;
...
<head>
   ...
   <title>Thales - <?php echo CATEGORIES_MODIFY_TITLE?></title>
</head>
...
<body>
   ...
   <div class="container mt-4">
      <!-- Contenu de la page -->
      <h1><?php echo CATEGORIES_MODIFY_TITLE?></h1>
      ...
      <form action="modifier-sous-categories.php?id=<?php echo $subcategories_id; ?>" method="post">
         ...
         <div class="form-group">
            <label for="name"><?php echo CATEGORIES_MODIFY_NAME?></label>
            <input type="text" class="form-control" name="name" id="name" value="<?php echo $subcategories['name']; ?>">
         </div>
         <!-- Catégorie parente -->
         <div class="form-group">
            <label for="parent_id"><?php echo CATEGORIES_MODIFY_PARENT?></label>
            <select class="form-control" id="parent_id" name="parent_id">
               <option value="" selected disabled hidden><?php echo CATEGORIES_MODIFY_SELECT_PARENT?></option>
