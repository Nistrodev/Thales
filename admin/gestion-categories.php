...
<head>
   ...
   <title>Thales - <?php echo CATEGORIES_MANAGE_TITLE?></title>
</head>
   ...
   <div class="container mt-4">
      ...
      <?php if ($cat) { ?>
         <table class="table table-striped table-bordered">
            <thead>
               <tr>
                  <th><?php echo CATEGORIES_MANAGE_ID?></th>
                  <th><?php echo CATEGORIES_MANAGE_NAME?></th>
                  <th><?php echo CATEGORIES_MANAGE_NB_SUBCATEGORIES?></th>
                  <?php if ((check_permission($conn, 'modify_categories')) or (check_permission($conn, 'delete_categories'))) { ?>
                     <th><?php echo CATEGORIES_MANAGE_ACTIONS?></th>
                  <?php } ?>
               </tr>
            </thead>
            <tbody>
      ...
      <?php } else { ?>
         <div class="alert alert-warning" role="alert"><?php echo CATEGORIES_MANAGE_NO_CATEGORIES?></div>
      <?php } ?>
      ...
      <nav aria-label="Page navigation example">
         <ul class="pagination">
            ...
            <li class="page-item <?php if ($page == 1) echo "disabled"; ?>">
               <a class="page-link" href="gestion-categories.php?page=<?php echo $page - 1; ?>&limit=<?php echo $limit; ?>"><?php PREVIOUS?></a>
            </li>
            <!-- Boutons des pages -->
            ...
            <li class="page-item <?php if ($page == $numPages) echo "disabled"; ?>">
               <a class="page-link" href="gestion-categories.php?page=<?php echo $page + 1; ?>&limit=<?php echo $limit; ?>"><?php NEXT?></a>
            </li>
         </ul>
      </nav>
   </div>
