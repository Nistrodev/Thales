...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['message-success'] = "Le rôle à été créer avec succès.";
...
<head>
   ...
   <title>Thales - Créer un rôle</title>
</head>
<body>
<!-- Sidebar -->
...
<div class="container mt-4">
   ...
   <form action="creation-role.php" method="post">
      ...
      <button type="submit" name="submit" class="btn btn-primary">Créer le rôle</button>
   </form>
</div>
<script>
